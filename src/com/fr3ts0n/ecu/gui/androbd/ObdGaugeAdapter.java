	...
	PvChangeListener
{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if(chartView == null)
		{
			...
			r.setColor(ChartActivity.getPidColor(pid));
			try
			{
		...
		convertView.setBackgroundColor(ChartActivity.getPidColor(pid) & 0x08FFFFFF);

		// set new values for display
		holder.tvDescr.setTextColor(ChartActivity.getPidColor(pid));
